...
const styles = `
  * { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .detail-hero {
    ...
    text-align: center;
    background: linear-gradient(180deg, #162416 0%, #0f1f0f 100%);
...
export default function PlantDetail({ plant, onEdit, onDelete, onWater, onBack, saving }) {
        ...
        <div className="sections">
          <div className="section">
            ...
            <div className="info-row">
              ...
              <span className="info-key">Fréquence</span>
              <span className="info-val">tous les {plant.arrosageFreq || 7} jours</span>
            </div>
            {plant.arrosageNote && (
              <div className="info-row">
                <span className="info-icon">📝</span>
          ...
          {plant.createdAt && (
            <div style={{ textAlign: 'center', color: '#3a5a3a', fontSize: '0.75rem', marginTop: '1rem' }}>
              Ajoutée le {formatDate(plant.createdAt)}
            </div>
          )}
        </div>
